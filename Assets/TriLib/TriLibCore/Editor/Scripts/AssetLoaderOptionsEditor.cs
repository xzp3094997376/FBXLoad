        ...
        public static void ShowInspectorGUI(SerializedObject serializedObject, ref int currentTab)
        {
            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty("ForceGCCollectionWhileLoading"), new GUIContent("Force GC Collection while loading", "Turn on this field to force the GC collection while loading the model and release memory promptly."));
